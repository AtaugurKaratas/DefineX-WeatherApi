...
public class WeatherInterfaceService {
    ...
    public WeatherInterfaceService(RestTemplate restTemplate, HttpHeaders httpHeaders) {
    ...
    public Weather getWeatherLocationWithTemp(String location, String temperatureType) {
        ...
        ResponseEntity<Weather> response = null;
        try {
            restTemplate.exchange((WeatherProcess.weatherUriPath + location + today +
                            WeatherProcess.unitGroup + temperatureType + WeatherProcess.weatherKey + WeatherProcess.contentType),
